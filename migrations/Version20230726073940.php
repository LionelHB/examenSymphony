 ...
 */
final class Version20230726073940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE listing (id INT AUTO_INCREMENT NOT NULL, model_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, product_year INT NOT NULL, mileage INT NOT NULL, price INT NOT NULL, created_at DATETIME NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_CB0048D47975B7E7 (model_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
